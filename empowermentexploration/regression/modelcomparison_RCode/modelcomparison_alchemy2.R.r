...
la2df_fullregression_m<-la2df_fullregression_summary$coefficients[1:2,1]
la2df_fullregression_se<-la2df_fullregression_summary$coefficients[1:2,2]

dataforplot_la2df_fullregression<-data.frame(mu=la2df_fullregression_m, ci=1.96*la2df_fullregression_se, 
...
#plot
plot_la2df_fullregression <- ggplot(dataforplot_la2df_fullregression, aes(x=model, y=mu)) + 
  #bars
