...
class ModelValues():
    ...
    """
    def __init__(self, player_data, time, game_version, split_version, vector_version, model_type, memory_type, z_score=True):
        ...
        cbv_model.reset()
        cbu_model = CBUModel(game_version)
        cbu_model.reset()
        sim_model = SimModel(game_version)
        bin_model = BinModel(game_version, split_version, vector_version)
        emp_model = EmpModel(game_version, split_version, vector_version)
        ...
        for trial in player_data:
            ...
            trial_data = {'id': player_id, 'trial': trial[1]}
            ...
            models = [('cbv', cbv_model), ('cbu', cbu_model), ('sim', sim_model), ('bin', bin_model), ('emp', emp_model), ('truebin', truebin_model), ('trueemp', trueemp_model)]
