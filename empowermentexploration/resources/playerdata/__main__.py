...
if __name__ == '__main__':
    ...
    #Behavior(version='alchemy2', memory=True, trials=100, model_type='truebin')
    #Behavior(version='tinyalchemy', memory=True, trials=100, model_type='truebin')
    #Behavior(version='tinypixels', memory=True, trials=100, model_type='truebin')
