...
class Inventory():
    ...
    def __init__(self, game_version='alchemy2'):
        ...
        Args:
            game_version (str, optional): 'joined', 'alchemy1' or 'alchemy2'. States what element and combination set is going to be used.
    ...
    def update(self, combination):
        ...
        Returns:
            tuple:  (1) New results that are not final
                    (2) New results
                    (3) 0 if unsuccessful, 1 if successful            
        """
        ...
        return (new_results_non_final, new_results_total, success)
