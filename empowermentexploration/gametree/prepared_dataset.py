...
class PreparedDataset():
    ...
    """
    def __init__(self, data, game_version='alchemy2', link_prediction=True, exclusion_elements=None, manual_validation=None, 
    ...
    def split_train_val_test_sets(self, data):
    ...
    def get_feature_and_label_vector(self, data, type=0):  
        ...
        # for element prediction model and train and val data: reduce data to only successful data
        if self.link_prediction is False and (type == 0 or type == 2):
